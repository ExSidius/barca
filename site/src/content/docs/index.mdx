...
<CardGrid>
	...
	<Card title="Built-in scheduler" icon="setting">
		`barca serve` runs your `@task`s on a cron tick — down to the second — with
		no external cron and no daemon service. See [Scheduling](/scheduling/).
	</Card>
</CardGrid>
