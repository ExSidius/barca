...
description: Tasks are the counterpart to assets — side effects that always re-run.
---
...
See [Error Handling](/patterns/06-error-handling/) for details on failure propagation and common mistakes.
