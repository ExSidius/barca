...
def launch():
    query = """mutation { launchRun(executionParams: { selector: { repositoryLocationName: "definitions.py", repositoryName: "__repository__", jobName: "partitioned_chain_job" }, runConfigData: "{}" }) { __typename ... on LaunchRunSuccess { run { runId } } ... on PythonError { message } } }"""
