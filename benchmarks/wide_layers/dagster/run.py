"""Dagster: wide layers — 3 layers of 20 assets, each layer depends on previous aggregate."""
...
@asset(
    ins={
        "l0_00": AssetIn(key="layer0_00"),
        "l0_01": AssetIn(key="layer0_01"),
        "l0_02": AssetIn(key="layer0_02"),
        "l0_03": AssetIn(key="layer0_03"),
        "l0_04": AssetIn(key="layer0_04"),
        "l0_05": AssetIn(key="layer0_05"),
        "l0_06": AssetIn(key="layer0_06"),
        "l0_07": AssetIn(key="layer0_07"),
        "l0_08": AssetIn(key="layer0_08"),
        "l0_09": AssetIn(key="layer0_09"),
        "l0_10": AssetIn(key="layer0_10"),
        "l0_11": AssetIn(key="layer0_11"),
        "l0_12": AssetIn(key="layer0_12"),
        "l0_13": AssetIn(key="layer0_13"),
        "l0_14": AssetIn(key="layer0_14"),
        "l0_15": AssetIn(key="layer0_15"),
        "l0_16": AssetIn(key="layer0_16"),
        "l0_17": AssetIn(key="layer0_17"),
        "l0_18": AssetIn(key="layer0_18"),
        "l0_19": AssetIn(key="layer0_19"),
    }
)
def agg_0(
    l0_00,
...
@asset(ins={"agg": AssetIn(key="agg_0")})
def layer1_00(agg):
...
@asset(
    ins={
        "l1_00": AssetIn(key="layer1_00"),
        "l1_01": AssetIn(key="layer1_01"),
        "l1_02": AssetIn(key="layer1_02"),
        "l1_03": AssetIn(key="layer1_03"),
        "l1_04": AssetIn(key="layer1_04"),
        "l1_05": AssetIn(key="layer1_05"),
        "l1_06": AssetIn(key="layer1_06"),
        "l1_07": AssetIn(key="layer1_07"),
        "l1_08": AssetIn(key="layer1_08"),
        "l1_09": AssetIn(key="layer1_09"),
        "l1_10": AssetIn(key="layer1_10"),
        "l1_11": AssetIn(key="layer1_11"),
        "l1_12": AssetIn(key="layer1_12"),
        "l1_13": AssetIn(key="layer1_13"),
        "l1_14": AssetIn(key="layer1_14"),
        "l1_15": AssetIn(key="layer1_15"),
        "l1_16": AssetIn(key="layer1_16"),
        "l1_17": AssetIn(key="layer1_17"),
        "l1_18": AssetIn(key="layer1_18"),
        "l1_19": AssetIn(key="layer1_19"),
    }
)
def agg_1(
    l1_00,
...
@asset(ins={"agg": AssetIn(key="agg_1")})
def layer2_00(agg):
...
@asset(
    ins={
        "l2_00": AssetIn(key="layer2_00"),
        "l2_01": AssetIn(key="layer2_01"),
        "l2_02": AssetIn(key="layer2_02"),
        "l2_03": AssetIn(key="layer2_03"),
        "l2_04": AssetIn(key="layer2_04"),
        "l2_05": AssetIn(key="layer2_05"),
        "l2_06": AssetIn(key="layer2_06"),
        "l2_07": AssetIn(key="layer2_07"),
        "l2_08": AssetIn(key="layer2_08"),
        "l2_09": AssetIn(key="layer2_09"),
        "l2_10": AssetIn(key="layer2_10"),
        "l2_11": AssetIn(key="layer2_11"),
        "l2_12": AssetIn(key="layer2_12"),
        "l2_13": AssetIn(key="layer2_13"),
        "l2_14": AssetIn(key="layer2_14"),
        "l2_15": AssetIn(key="layer2_15"),
        "l2_16": AssetIn(key="layer2_16"),
        "l2_17": AssetIn(key="layer2_17"),
        "l2_18": AssetIn(key="layer2_18"),
        "l2_19": AssetIn(key="layer2_19"),
    }
)
def final_output(
    l2_00,
