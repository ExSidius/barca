...
from trace import clear_caches, extract_dependencies
...
def run_tests():
    ...
    results.append(("Case 14: class in dependency cone", has_derived, f"DerivedProcessor={has_derived}, BaseProcessor={has_base}, deps: {list(deps.dependencies.keys())}"))
    ...
    results.append(("Case 14b: base class detected as dependency", has_base_direct, f"BaseProcessor={has_base_direct}, deps: {list(deps_base.dependencies.keys())}"))
